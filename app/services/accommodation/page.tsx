          ...
          <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              ...
              <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button size="lg" className="h-14 px-8 rounded-full text-lg shadow-lg hover:shadow-primary/20 transition-all bg-primary text-primary-foreground hover:bg-primary/90" asChild>
                  <Link href="/get-started">
                    <Search className="w-5 h-5 mr-2" /> Find Housing
                  </Link>
                </Button>
                <Button variant="outline" size="lg" className="h-14 px-8 rounded-full text-lg gap-2 hover:bg-secondary" asChild>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="flex-1 space-y-8">
              <h2 className="text-3xl font-bold">The EdMaster Advantage</h2>
      ...
      <section className="py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="h-14 px-10 rounded-full text-lg font-bold bg-background text-foreground hover:bg-secondary" asChild>
              <Link href="/get-started">
                Start Your Search
              </Link>
            </Button>

  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-slate-50">
        {/* Soft Background Gradients (Teal/Blue for TOEFL) */}
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-teal-100/40 rounded-full blur-[120px] -z-10 translate-x-1/4 -translate-y-1/4" />
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-100/40 rounded-full blur-[120px] -z-10 -translate-x-1/4 translate-y-1/4" />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              <motion.div variants={fadeInUp} className="inline-flex flex-wrap justify-center lg:justify-start gap-2 mb-6">
                <Badge variant="secondary" className="bg-teal-50 text-teal-700 hover:bg-teal-100 border-teal-200 px-4 py-1.5 text-sm font-semibold rounded-full uppercase tracking-wider">
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button size="lg" className="h-14 px-8 rounded-xl text-base font-bold bg-teal-600 hover:bg-teal-700 text-white shadow-lg shadow-teal-900/10" asChild>
                  <Link href="/get-started">
                    Book Free Demo <ArrowRight className="ml-2 w-5 h-5" />
                  </Link>
                </Button>
                <Button size="lg" variant="outline" className="h-14 px-8 rounded-xl text-base font-bold border-slate-200 text-slate-700 hover:bg-white hover:text-teal-700 hover:border-teal-200 bg-white" asChild>
              ...
              <motion.div variants={fadeInUp} className="mt-10 pt-8 border-t border-slate-200 flex flex-wrap justify-center lg:justify-start gap-8">
                ...
                <div className="flex items-center gap-2">
                  <div className="p-2 bg-teal-100 rounded-lg text-teal-700"><Video className="w-5 h-5" /></div>
                  <div className="text-sm font-medium text-slate-600">
            ...
            >
              <div className="relative z-10 bg-white rounded-[2rem] shadow-2xl shadow-teal-900/10 p-8 border border-slate-100 max-w-md mx-auto">
                <div className="flex items-center justify-between mb-6 pb-6 border-b border-slate-100">
                  ...
                  <Badge className="bg-teal-600">On Track</Badge>
                </div>
                
                <div className="space-y-5">
                  {[
                    { label: "Reading", score: "28/30", color: "bg-teal-500" },
              ...
              {/* Decorative Elements */}
              <div className="absolute -z-10 top-[-30px] right-[-30px] w-40 h-40 bg-teal-400/20 rounded-full blur-3xl" />
      ...
      <section id="exam-pattern" className="py-24 bg-slate-50 border-y border-slate-200">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-teal-600 font-bold uppercase tracking-wider text-sm">Exam Structure</span>
          ...
          <div className="max-w-5xl mx-auto bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            {[
              { section: "Reading", time: "35 mins", qs: "20 Questions", tasks: "Read passages and respond to questions", color: "text-blue-600" },
              { section: "Listening", time: "36 mins", qs: "28 Questions", tasks: "Answer questions about lectures/discussions", color: "text-purple-600" },
              { section: "Speaking", time: "16 mins", qs: "4 Tasks", tasks: "Talk about familiar topics & discuss material", color: "text-orange-600" },
              { section: "Writing", time: "29 mins", qs: "2 Tasks", tasks: "Read, listen, and type your response", color: "text-teal-600" },
            ].map((row, i) => (
              <div key={i} className="grid grid-cols-4 p-6 border-b border-slate-100 hover:bg-slate-50 transition-colors items-center">
                ...
                <div className="hidden md:block text-slate-500 text-sm">{row.tasks}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <motion.div whileHover={{ y: -5 }} className="p-8 rounded-2xl bg-teal-50 border border-teal-100 hover:shadow-md transition-all">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-bold text-xl text-slate-900">Weekday Batch</h3>
                <div className="p-2 bg-white rounded-lg text-teal-600"><Calendar className="w-5 h-5" /></div>
              </div>
              <p className="text-sm text-slate-500 font-semibold uppercase tracking-wider mb-2">Monday - Friday</p>
              <div className="text-3xl font-bold text-teal-700">06:00 PM - 07:00 PM</div>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <div className="bg-white p-8 rounded-3xl border-2 border-teal-500 shadow-xl relative overflow-hidden">
            ...
            <div className="mt-10 pt-8 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <Button size="lg" className="h-14 px-10 rounded-xl text-lg bg-teal-600 hover:bg-teal-700 text-white shadow-lg">
                Enroll Now
              </Button>
            </div>
          </div>
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            {[
              ...
              <AccordionItem key={i} value={`item-${i}`} className="bg-slate-50 rounded-xl border border-slate-200 px-2 shadow-sm">
                <AccordionTrigger className="text-left font-semibold text-lg py-5 px-4 hover:no-underline hover:text-teal-700 transition-colors text-slate-800">
                  {faq.q}
                </AccordionTrigger>
      ...
      <section className="py-24 bg-slate-900 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="h-16 px-10 rounded-xl text-lg bg-teal-500 hover:bg-teal-600 text-white font-bold shadow-xl" asChild>
